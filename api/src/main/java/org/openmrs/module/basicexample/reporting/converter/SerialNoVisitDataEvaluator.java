...
@Handler(supports = SerialNoVisitDataDefinition.class, order = 53)
public class SerialNoVisitDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id,pi.identifier FROM openmrs.encounter e "
		        ...
		        + "AND pit.name in('Patient Clinic Number') group by e.encounter_id";
