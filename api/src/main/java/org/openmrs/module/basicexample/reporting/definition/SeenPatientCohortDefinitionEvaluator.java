...
@Handler(supports = { SeenPatientCohortDefinition.class })
public class SeenPatientCohortDefinitionEvaluator implements EncounterQueryEvaluator {
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "select encounter_id FROM openmrs.encounter WHERE encounter_datetime BETWEEN DATE(:startDate) AND DATE(:endDate);";
